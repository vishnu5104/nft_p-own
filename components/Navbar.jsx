...
// reusable as possible  -> Components
// (get it as a promnt setactive)
const ButtonGroup = ({ setActive, router }) => {
  // if hasConnected the create nft
  // else do Connect it.
  ...
  return currentAccount ? (
    ...
    <Button
      btnName="Connect"
      classStyles="mx-2 rounded-xl"
      // it call the connectWallet function if the button is clicked
